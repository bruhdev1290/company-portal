 ...
 */ !(function (e) {
  ...
  function (e, t, n) {
    (function (e) {
      ...
      $(document).ready(function () {
        ...
        var e = n(27),
          i = $(".global-header"),
          o = $("body").attr("data-active-page");
        i.html(e({ activePage: o })),
          i
            .find('a[href="' + o + '.html"]')
            .addClass("global-nav_link__active");
        var a = n(28),
          s = $(".global-footer");
        if (
          (s.html(a),
          $(".table__sortable").find(".sortable__start-down").click(),
          $('a[href="#print"]').on("click", function (e) {
            e.preventDefault(), window.print();
          }),
          $(".cases-table").length > 0)
        ) {
          var l = window.location.search.replace("?alert=", "");
          if (l) {
            var u = {
              "past-due": "past",
              "due-soon": "soon",
        ...
        if (
          ...
          $(".complaint_response").length > 0 &&
            ...
            $("#response_type").on("change", ".cf-input", function (e) {
              ...
              "monetary-relief" === t ||
              "non-monetary" === t
                ? $("#privacy-protection").is(":checked") &&
                  n.addClass("upload-required")
                : n.removeClass("upload-required");
            })),
          $(".user").length > 0 &&
            $("#user_account").on("submit", function (e) {
              $(this).attr("data-updated", !0),
                window.scrollTo(0, 0),
                e.preventDefault();
            }),
          $(".manage-users").length > 0 &&
            $(".manage-users_table").on(
              "change",
              '.cf-input[type="checkbox"]',
              function (e) {
                var t = $(
                    '.manage-users_table .cf-input[type="checkbox"]:checked'
                  ).length,
                  n = $(".manage-users_change-status");
                t > 0
                  ? n.removeClass("btn__disabled")
                  : n.addClass("btn__disabled");
              }
            ),
          $(".create-user").length > 0)
        ) {
          $("#select-all-products").on("click", function (e) {
            var t = $(".user_products .cf-input");
            t.prop("checked", !0);
          });
          var f = window.location.search.replace("?edit=", "");
          if (f) {
            var p = $(".create-user .cf-input").not(
              "#export_no, #status_inactive"
            );
            $(".create-user h1").text("Update user"),
              $("#user_first").val("Nicholas"),
              $("#user_last").val("Johnson"),
              $("#user_phone").val("(555) 321-3181"),
              $("#user_email").val("nicholas.johnson@acmebank.com"),
              $("#user_title").val("Investigator"),
              $("#user_username").val("nicholas.johnson@acmebank.com"),
              p.prop("checked", !0),
              $('.create-user button[type="submit"]').text("Update user");
          }
        }
      });
    }.call(
  ...
  function (e, t, n) {
    ...
    !(function (t, n) {
      ...
      function c() {
        ye.addEventListener
          ? (ye.removeEventListener("DOMContentLoaded", d, !1),
            n.removeEventListener("load", d, !1))
          : (ye.detachEvent("onreadystatechange", d),
      ...
      function h(e, t, n, r) {
        if (le.acceptData(e)) {
          ...
          if (
            ...
            return (
              u || (u = s ? (e[a] = K.pop() || le.guid++) : a),
              l[u] || (l[u] = s ? {} : { toJSON: le.noop }),
              ("object" == typeof t || "function" == typeof t) &&
                (r
                  ? (l[u] = le.extend(l[u], t))
                  : (l[u].data = le.extend(l[u].data, t))),
              (o = l[u]),
              r || (o.data || (o.data = {}), (o = o.data)),
              void 0 !== n && (o[le.camelCase(t)] = n),
              "string" == typeof t
                ? ((i = o[t]), null == i && (i = o[le.camelCase(t)]))
                : (i = o),
              i
            );
        }
      ...
      function N(e, t) {
        ...
        if (1 === t.nodeType) {
          if (
            ((n = t.nodeName.toLowerCase()), !ae.noCloneEvent && t[le.expando])
          ) {
            i = le._data(t);
      ...
      function S(e, t) {
        var r,
          i = le(t.createElement(e)).appendTo(t.body),
          o =
      ...
      function D(e) {
        ...
        return (
          n ||
            ...
            ("none" !== n && n) ||
              ((nt = (
                nt || le("<iframe frameborder='0' width='0' height='0'/>")
      ...
      function M(e, t) {
        if (t in e) return t;
        for (
          var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = gt.length;
          i--;
            ...
            r.style &&
              ...
              t
                ? (o[a] || "none" !== n || (r.style.display = ""),
                  "" === r.style.display &&
                    je(r) &&
                    (o[a] = le._data(r, "olddisplay", D(r.nodeName))))
                : ((i = je(r)),
                  ((n && "none" !== n) || !i) &&
      ...
      function L(e, t, n, r, i) {
        for (
          ...
          "margin" === n && (a += le.css(e, n + Me[o], !0, i)),
            r
              ? ("content" === n && (a -= le.css(e, "padding" + Me[o], !0, i)),
                "margin" !== n &&
                  (a -= le.css(e, "border" + Me[o] + "Width", !0, i)))
              : ((a += le.css(e, "padding" + Me[o], !0, i)),
                "padding" !== n &&
                  (a += le.css(e, "border" + Me[o] + "Width", !0, i)));
        return a;
      }
      ...
      function I(e, t, n) {
        ...
        n.queue ||
          ...
          1 === e.nodeType &&
            ...
            "inline" === c &&
              "none" === le.css(e, "float") &&
              (ae.inlineBlockNeedsLayout && "inline" !== D(e.nodeName)
                ? (p.zoom = 1)
      ...
      function R(e, t, n) {
        ...
        for (B(c, u.opts.specialEasing); a > o; o++)
          if ((r = Ct[o].call(u, e, c, u.opts))) return r;
        return (
          le.map(c, F, u),
              ...
              if (null != (i = arguments[s]))
                for (r in i)
                  (e = a[r]),
                    (n = i[r]),
                    a !== n &&
                      (u && n && (le.isPlainObject(n) || (t = le.isArray(n)))
                        ? (t
                            ? ((t = !1), (o = e && le.isArray(e) ? e : []))
                            : (o = e && le.isPlainObject(e) ? e : {}),
                          (a[r] = le.extend(u, o, n)))
                        : void 0 !== n && (a[r] = n));
            return a;
          }),
        ...
        (w = t.support = {}),
                        ...
                        return n
                          ...
                          : ((n =
                            ...
                            (!w.sortDetached &&
                              ...
                              ? e === r || (e.ownerDocument === I && q(I, e))
                                ? -1
                                : t === r || (t.ownerDocument === I && q(I, t))
                                ? 1
                                : D
                                ? ee(D, e) - ee(D, t)
                                : 0
          ...
          (t.attr = function (e, t) {
            ...
            var n = C.attrHandle[t.toLowerCase()],
              r =
                n && Q.call(C.attrHandle, t.toLowerCase())
                  ? n(e, t, !L)
                  : void 0;
            return void 0 !== r
              ? r
            ...
            function (e, t, n, r) {
              ...
              if (((n = n || []), 1 === d.length)) {
                if (
                  ...
                  if (
                    ((t = (C.find.ID(a.matches[0].replace(we, Ce), t) ||
                      [])[0]),
                    !t)
                  )
                    return n;
      ...
      (le.filter = function (e, t, n) {
        ...
        le.fn.extend({
          ...
          is: function (e) {
            return !!s(
              this,
              "string" == typeof e && he.test(e) ? le(e) : e || [],
              !1
            ).length;
          },
        });
      ...
      le.extend({
        dir: function (e, t, n) {
          for (
            ...
            i &&
            9 !== i.nodeType &&
            (void 0 === n || 1 !== i.nodeType || !le(i).is(n));
        ...
        le.extend({
          ...
          ready: function (e) {
            if (e === !0 ? !--le.readyWait : !le.isReady) {
              ...
              (le.isReady = !0),
                (e !== !0 && --le.readyWait > 0) ||
                  (_e.resolveWith(ye, [le]),
                  le.fn.triggerHandler &&
                    (le(ye).triggerHandler("ready"), le(ye).off("ready")));
            }
          },
        }),
        (le.ready.promise = function (e) {
          if (!_e)
            if (((_e = le.Deferred()), "complete" === ye.readyState))
              setTimeout(le.ready);
              ...
              if (
                ...
                for (n = a.length; n--; )
                  a[n] &&
                    ((r = a[n].name),
                    0 === r.indexOf("data-") &&
                      ((r = le.camelCase(r.slice(5))), f(o, r, i[r])));
      ...
      !(function () {
        ...
        if (
          ...
          (ae.html5Clone =
            "<:nav></:nav>" !==
            ye.createElement("nav").cloneNode(!0).outerHTML),
          (e.type = "checkbox"),
          (e.checked = !0),
          n.appendChild(e),
      ...
      (le.event = {
              ...
              n.handler && ((l = n), (n = l.handler), (i = l.selector)),
                ...
                (c = g.handle) ||
                  ((c = g.handle =
                    function (e) {
                      return typeof le === Ne ||
                        (e && le.event.triggered === e.type)
                        ? void 0
                        : le.event.dispatch.apply(c.elem, arguments);
                    }),
                  (c.elem = e)),
                t = (t || "").match(Te) || [""],
                s = t.length;
        ...
        remove: function (e, t, n, r, i) {
          ...
          if (g && (c = g.events)) {
            ...
            le.isEmptyObject(c) &&
              (delete g.handle, le._removeData(e, "events"));
          }
        },
        trigger: function (e, t, r, i) {
          ...
          if (
            ...
            3 !== r.nodeType &&
              8 !== r.nodeType &&
              !qe.test(p + le.event.triggered) &&
              (p.indexOf(".") >= 0 &&
                ((h = p.split(".")), (p = h.shift()), h.sort()),
              (a = p.indexOf(":") < 0 && "on" + p),
              (e = e[le.expando]
                ? e
                : new le.Event(p, "object" == typeof e && e)),
              (e.isTrigger = i ? 2 : 3),
              (e.namespace = h.join(".")),
        ...
        dispatch: function (e) {
          ...
          if (
            ...
            for (
              a = le.event.handlers.call(this, e, l), t = 0;
        ...
        fix: function (e) {
          ...
          for (
            a ||
              (this.fixHooks[i] = a =
                Pe.test(i) ? this.mouseHooks : $e.test(i) ? this.keyHooks : {}),
            ...
            (n = r[t]), (e[n] = o[n]);
          return (
            e.target || (e.target = o.srcElement || ye),
              ...
              return le.nodeName(this, "form")
                ...
                : void le.event.add(
                    ...
                    function (e) {
                      var t = e.target,
                        n =
                          le.nodeName(t, "input") || le.nodeName(t, "button")
                            ? t.form
                            : void 0;
                      n &&
          ...
          le.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
            ...
            le.event.special[t] = {
              ...
              teardown: function () {
                ...
                i
                  ? le._data(r, t, i)
                  : (r.removeEventListener(e, n, !0), le._removeData(r, t));
              },
            };
          }),
        le.fn.extend({
      ...
      (Ze.optgroup = Ze.option),
        ...
        le.extend({
          clone: function (e, t, n) {
            ...
            if (
              ...
              !(
                (ae.noCloneEvent && ae.noCloneChecked) ||
          ...
          buildFragment: function (e, t, n, r) {
            for (
              var i, o, a, s, l, u, c, d = e.length, f = b(t), p = [], h = 0;
              d > h;
              h++
            )
              if (((o = e[h]), o || 0 === o))
                if ("object" === le.type(o)) le.merge(p, o.nodeType ? [o] : o);
                  ...
                  for (
                    s = s || f.appendChild(t.createElement("div")),
                      ...
                      c = Ze[l] || Ze._default,
                      s.innerHTML = c[1] + o.replace(ze, "<$1></$2>") + c[2],
                      i = c[0];
                    i--;
                    ...
                    s = s.lastChild;
                  if (
                    (!ae.leadingWhitespace &&
                      We.test(o) &&
                      p.push(t.createTextNode(We.exec(o)[0])),
                    !ae.tbody)
                  )
                    for (
                      o =
                      ...
                      le.nodeName((u = o.childNodes[i]), "tbody") &&
                        ...
                        o.removeChild(u);
                  for (
                    le.merge(p, s.childNodes), s.textContent = "";
                    s.firstChild;
        ...
        le.fn.extend({
            ...
            return He(
              ...
              function (e) {
                return void 0 === e
                  ? le.text(this)
                  : this.empty().append(
                      ((this[0] && this[0].ownerDocument) || ye).createTextNode(
                        e
                      )
                    );
              },
          ...
          remove: function (e, t) {
            for (
              var n, r = e ? le.filter(e, this) : this, i = 0;
              null != (n = r[i]);
              i++
            )
              t || 1 !== n.nodeType || le.cleanData(x(n)),
                n.parentNode &&
                  (t && le.contains(n.ownerDocument, n) && _(x(n, "script")),
          ...
          html: function (e) {
            return He(
              ...
              function (e) {
                ...
                if (void 0 === e)
                  return 1 === t.nodeType
                    ? t.innerHTML.replace(Be, "")
                    : void 0;
                if (
                  "string" == typeof e &&
                  !Qe.test(e) &&
                  (ae.htmlSerialize || !Re.test(e)) &&
                  (ae.leadingWhitespace || !We.test(e)) &&
                  !Ze[(Xe.exec(e) || ["", ""])[1].toLowerCase()]
                ) {
                  e = e.replace(ze, "<$1></$2>");
                  try {
                    for (; r > n; n++)
                      (t = this[n] || {}),
                        1 === t.nodeType &&
                          (le.cleanData(x(t, !1)), (t.innerHTML = e));
                    t = 0;
                  } catch (i) {}
                }
          ...
          domManip: function (e, t) {
            ...
            if (
              p ||
              (u > 1 && "string" == typeof f && !ae.checkClone && Ye.test(f))
            )
            ...
            if (
              u &&
              ((s = le.buildFragment(e, this[0].ownerDocument, !1, this)),
              (n = s.firstChild),
              1 === s.childNodes.length && (s = n),
              n)
            ) {
              for (o = le.map(x(s, "script"), T), i = o.length; u > l; l++)
                (r = s),
                  l !== d &&
                    ((r = le.clone(r, !0, !0)),
              ...
              if (i)
                for (
                  a = o[o.length - 1].ownerDocument, le.map(o, k), l = 0;
                  i > l;
                  l++
                )
                  (r = o[l]),
        ...
        le.each(
          ...
          function (e, t) {
            le.fn[e] = function (e) {
              for (
                var n, r = 0, i = [], o = le(e), a = o.length - 1;
                a >= r;
                r++
              )
      ...
      n.getComputedStyle
        ...
        : ye.documentElement.currentStyle &&
          ((it = function (e) {
      ...
      le.extend({
        ...
        style: function (e, t, n, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var i,
              ...
              l = e.style;
            if (
              ((t = le.cssProps[s] || (le.cssProps[s] = M(l, s))),
            ...
            if (
              ...
              "string" === o &&
                (i = pt.exec(n)) &&
                ((n = (i[1] + 1) * i[2] + parseFloat(le.css(e, t))),
                (o = "number")),
              null != n &&
                n === n &&
                ("number" !== o || le.cssNumber[s] || (n += "px"),
                ae.clearCloneStyle ||
                  "" !== n ||
        ...
        css: function (e, t, n, r) {
          var i,
            ...
            s = le.camelCase(t);
          return (
            (t = le.cssProps[s] || (le.cssProps[s] = M(e.style, s))),
            (a = le.cssHooks[t] || le.cssHooks[s]),
            a && "get" in a && (o = a.get(e, !0, n)),
            void 0 === o && (o = ot(e, t, r)),
            "normal" === o && t in mt && (o = mt[t]),
            "" === n || n
              ? ((i = parseFloat(o)), n === !0 || le.isNumeric(i) ? i || 0 : o)
              : o
          );
        },
      }),
        le.each(["height", "width"], function (e, t) {
          le.cssHooks[t] = {
            get: function (e, n, r) {
              return n
                ? dt.test(le.css(e, "display")) && 0 === e.offsetWidth
                  ? le.swap(e, ht, function () {
                      return O(e, t, r);
                    })
                  : O(e, t, r)
                : void 0;
        ...
        ae.opacity ||
          (le.cssHooks.opacity = {
            ...
            set: function (e, t) {
              ...
              (n.zoom = 1),
                ((t >= 1 || "" === t) &&
                  "" === le.trim(o.replace(ut, "")) &&
                  n.removeAttribute &&
                  (n.removeAttribute("filter"),
                  "" === t || (r && !r.filter))) ||
                  (n.filter = ut.test(o) ? o.replace(ut, i) : o + " " + i);
            },
          }),
        (le.cssHooks.marginRight = A(ae.reliableMarginRight, function (e, t) {
          return t
            ? le.swap(e, { display: "inline-block" }, ot, [e, "marginRight"])
            : void 0;
        })),
          ...
          "*": [
            function (e, t) {
              var n = this.createTween(e, t),
                ...
                a =
                  (le.cssNumber[e] || ("px" !== o && +r)) &&
                  xt.exec(le.css(n.elem, e)),
                s = 1,
                l = 20;
              if (a && a[3] !== o) {
                (o = o || a[3]), (i = i || []), (a = +r || 1);
                do (s = s || ".5"), (a /= s), le.style(n.elem, e, a + o);
        ...
        val: function (e) {
            ...
            i = this[0];
          {
            if (arguments.length)
              return (
                ...
                this.each(function (n) {
                  var i;
                  1 === this.nodeType &&
                    ((i = r ? e.call(this, n, le(this).val()) : e),
                    null == i
                      ? (i = "")
                      : "number" == typeof i
                      ? (i += "")
                      : le.isArray(i) &&
                        (i = le.map(i, function (e) {
                          return null == e ? "" : e + "";
                        })),
                    (t =
            ...
            if (i)
              return (
                (t =
                  le.valHooks[i.type] || le.valHooks[i.nodeName.toLowerCase()]),
        ...
        le.extend({
          valHooks: {
            ...
            select: {
              ...
              set: function (e, t) {
                for (
                  var n, r, i = e.options, o = le.makeArray(t), a = i.length;
                  a--;

                )
                  if (
                    ((r = i[a]), le.inArray(le.valHooks.option.get(r), o) >= 0)
                  )
                    try {
                      r.selected = n = !0;
                    } catch (s) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
              return typeof e.getAttribute === Ne
                ...
                : ((1 === o && le.isXMLDoc(e)) ||
                    ...
                    (r =
                      le.attrHooks[t] ||
                      (le.expr.match.bool.test(t) ? Et : _t))),
                  void 0 === n
          ...
          set: function (e, t, n) {
            return (
              t === !1
                ? le.removeAttr(e, n)
                : (At && Dt) || !St.test(n)
                ? e.setAttribute((!Dt && le.propFix[n]) || n, n)
          ...
          propHooks: {
            tabIndex: {
              get: function (e) {
                ...
                return t
                  ? parseInt(t, 10)
                  : Mt.test(e.nodeName) || (jt.test(e.nodeName) && e.href)
                  ? 0
                  : -1;
              },
            },
      ...
      le.fn.extend({
        ...
        toggleClass: function (e, t) {
          ...
          return "boolean" == typeof t && "string" === n
            ...
            : this.each(function () {
                if ("string" === n)
                  for (
                    var t, r = 0, i = le(this), o = e.match(Te) || [];
                    (t = o[r++]);
        ...
        hasClass: function (e) {
          for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
            if (
              1 === this[n].nodeType &&
              (" " + this[n].className + " ").replace(Ht, " ").indexOf(t) >= 0
            )
              return !0;
          return !1;
        },
      ...
      try {
        ...
        (qt = ye.createElement("a")), (qt.href = ""), (qt = qt.href);
      }
      (Pt = Xt.exec(qt.toLowerCase()) || []),
        le.extend({
          active: 0,
          lastModified: {},
          etag: {},
          ...
          ajax: function (e, t) {
                ...
                i
                  ? (d.ifModified &&
                    ...
                    204 === e || "HEAD" === d.type
                      ...
                      : 304 === e
                      ? (C = "notmodified")
                      : ((C = y.state), (c = y.data), (v = y.error), (i = !v)))
                  : ((v = C), (e || !C) && ((C = "error"), 0 > e && (e = 0))),
                (w.status = e),
                (w.statusText = (t || C) + ""),
                i ? h.resolveWith(f, [c, C, w]) : h.rejectWith(f, [w, C, v]),
                w.statusCode(g),
                (g = void 0),
                l &&
                  p.trigger(i ? "ajaxSuccess" : "ajaxError", [w, d, i ? c : v]),
                m.fireWith(f, [w, C]),
                l &&
            ...
            if (
              ...
              d.data &&
                ...
                (d.data = le.param(d.data, d.traditional)),
              z(Vt, d, t, w),
              2 === b)
            )
              return w;
        ...
        le.each(["get", "post"], function (e, t) {
          le[t] = function (e, n, r, i) {
            return (
              le.isFunction(n) && ((i = i || r), (r = n), (n = void 0)),
      ...
      (le.param = function (e, t) {
        ...
        if (
          (void 0 === t && (t = le.ajaxSettings && le.ajaxSettings.traditional),
      ...
      n.attachEvent &&
        ...
        le.ajaxTransport("script", function (e) {
          if (e.crossDomain) {
            var t,
              n = ye.head || le("head")[0] || ye.documentElement;
            return {
              send: function (r, i) {
      ...
      le.ajaxSetup({
        ...
        le.ajaxPrefilter("json jsonp", function (e, t, r) {
          ...
          return s || "jsonp" === e.dataTypes[0]
            ? ((i = e.jsonpCallback =
                le.isFunction(e.jsonpCallback)
                  ? e.jsonpCallback()
                  : e.jsonpCallback),
              s
                ? (e[s] = e[s].replace(an, "$1" + i))
                : e.jsonp !== !1 &&
      ...
      (le.fn.load = function (e, t, n) {
        ...
        var r,
          ...
          s = e.indexOf(" ");
        return (
          s >= 0 && ((r = le.trim(e.slice(s, e.length))), (e = e.slice(0, s))),
          le.isFunction(t)
            ? ((n = t), (t = void 0))
      ...
      (le.offset = {
        ...
        le.each(["top", "left"], function (e, t) {
          le.cssHooks[t] = A(ae.pixelPosition, function (e, n) {
            return n
              ? ((n = ot(e, t)), st.test(n) ? le(e).position()[t] + "px" : n)
              : void 0;
          });
        }),
        ...
        (function (e) {
          (e.fn.expandable = function (t) {
            return e(this).each(function () {
              var t = e(this),
                n = t
                  .find(".expandable_target")
                  .not(t.find(".expandable .expandable_target")),
                r = t
                  .find(".expandable_cue-open")
                  .not(t.find(".expandable .expandable_cue-open")),
                i = t
                  .find(".expandable_cue-close")
                  .not(t.find(".expandable .expandable_cue-close")),
                o = t
                  .find(".expandable_content")
                  .not(t.find(".expandable .expandable_content")),
                a = t.parents(".expandable-group"),
                s = a.length > 0 && a.data("accordion");
              if (s) var l = t.siblings(".expandable");
              (this.init = function () {
                n.attr("aria-controls", o.attr("id")),
                  t.hasClass("expandable__expanded")
                    ? this.expand(0)
                    : this.collapse(0),
                  n.on("click", e.proxy(this.handleClick, this));
              }),
                ...
                (this.expand = function (a) {
                  r.css("display", "none"),
                    ...
                    "undefined" == typeof a &&
                      (a = e.fn.expandable.calculateExpandDuration(o.height())),
                    t.addClass("expandable__expanded"),
                    o.slideDown({ duration: a, easing: "easeOutExpo" });
                }),
                (this.collapse = function (a) {
                  r.css("display", "inline"),
                    ...
                    "undefined" == typeof a &&
                      (a = e.fn.expandable.calculateCollapseDuration(
                        o.height()
                      )),
                    t.removeClass("expandable__expanded"),
                    o.slideUp({ duration: a, easing: "easeOutExpo" });
                }),
                this.init();
            });
          }),
            (e.fn.expandable.calculateExpandDuration = function (t) {
              return e.fn.expandable.constrainValue(450, 900, 4 * t);
            }),
            (e.fn.expandable.calculateCollapseDuration = function (t) {
              return e.fn.expandable.constrainValue(350, 900, 2 * t);
            }),
            (e.fn.expandable.constrainValue = function (e, t, n) {
      ...
      (e.easing.jswing = e.easing.swing),
        e.extend(e.easing, {
          ...
          easeInOutBounce: function (t, n, r, i, o) {
            return o / 2 > n
              ? 0.5 * e.easing.easeInBounce(t, 2 * n, 0, i, o) + r
              : 0.5 * e.easing.easeOutBounce(t, 2 * n - o, 0, i, o) +
                  0.5 * i +
                  r;
          },
        });
        ...
        (function (e) {
          ...
          var t = function (t, n) {
            function r(t) {
              (u = e.extend({}, l, t)),
                s(),
                d.find(".sortable__start-up, .sortable__start-up").click();
            }
            function i(e, t) {
              return function (n, r) {
                return (
            ...
            function a(e) {
              ...
              for (var t = 0; t < c.length; t++)
                d.find("tbody").append(c[t][1]);
            }
            function s() {
              f.on("click", function () {
                var t = e(this),
                  n = t.closest("th, td"),
                  r = n.closest(".table__sortable"),
                  s = t.attr("data-sort_type"),
                  l = 1,
                  u = r.find("tr:first-child"),
                  d = u.children("th, td").index(n);
                o(d),
                  (t.hasClass("sorted-up") ||
                    t.hasClass("sortable__start-down")) &&
                    (l = -1),
                  f.removeClass("sortable__start-down sortable__start-up"),
                  f.removeClass("sorted-down sorted-up"),
                  1 === l ? t.addClass("sorted-up") : t.addClass("sorted-down"),
                  c.sort(i(l, s)),
                  a(d);
              });
            }
          ...
          (e.fn.sortableTable = function (n) {
            ...
            e(document).ready(function () {
              e(".table__sortable").sortableTable();
            });
        })(jQuery);
    }.call(
      t,
  ...
  function (e, t) {
    ...
    var n = {
      init: function () {
        var e = $('a[href="#not-yet"]'),
          t = $('form[action="#not-yet"]');
        e.on("click", function (e) {
          e.preventDefault(), alert("This link is just a placeholder");
        }),
          t.on("submit", function (e) {
            e.preventDefault(), alert("This form is just a placeholder");
          });
      },
    };
    e.exports = n;
    ...
    function r() {
      function e(e) {
        ...
        var t = document.getElementsByTagName("body")[0],
          n = t.appendChild(a);
        return (
          (s = n.querySelector("." + c + "_offset")),
          (l = n.querySelector("." + c + "_bg")),
          (u = n.querySelector("." + c + "_close button")),
          this
        );
      }
      function t() {
      ...
      function n() {
        return a.addEventListener("mousedown", o), this;
      }
      function r() {
        return { container: a };
      }
      function o(e) {
        var n = e.target;
        (n === s || n === l || n === u) &&
          $(".o-modal").animate({ opacity: 0 }, 100, function () {
            t();
          });
      }
      var a,
  ...
  function (e, t) {
    ...
    function n(e, t) {
      var i = t && t.loc,
        ...
        a = void 0;
      i &&
        ((o = i.start.line), (a = i.start.column), (e += " - " + o + ":" + a));
      for (
  ...
  function (e, t, n) {
          ...
          e.useDepths &&
            (s = o.depths
              ? t !== o.depths[0]
                ...
                : o.depths
              : [t]),
          (n = f(e.main, n, i, o.depths || [], a, l))(t, o)
        );
      }
    ...
    function d(e, t) {
      return (
        (t && "root" in t) || ((t = t ? v.createFrame(t) : {}), (t.root = e)), t
      );
    }
